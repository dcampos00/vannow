...
- **Working on Firmware?** Start with [`firmware_documentation.md`](firmware_documentation.md) for class models and state machines, then check [`roadmap.md`](roadmap.md) for prioritized features and [`logic_audit_2026-09-11.md`](logic_audit_2026-09-11.md) for the active logic findings (channel-map identity, Shower Mode keep-alive oscillation, encoder dual-dispatch).
- **Working on Hardware & PCB?** Review [`logic_audit_2026-09-11.md`](logic_audit_2026-09-11.md) for the current hardware/firmware desynchronization and residual electrical issues, [`logic_audit_2026-09-03.md`](logic_audit_2026-09-03.md) for the historical DevKit socket short (now fixed), [`evaluacion_hardware.md`](evaluacion_hardware.md) for MCU specs, [`analisis_critico_riesgos.md`](analisis_critico_riesgos.md) for flyback/bypass safety rules, and inspect [`references/`](references/) for component datasheets.
...
| [**breadboard_prototyping_and_validation_guide.md**](breadboard_prototyping_and_validation_guide.md) | EN | Active (Lab) | Authoritative step-by-step breadboard assembly, pin-by-pin wiring schematics, and 6-phase hardware validation protocol. |
...
| [**skills/pcb-layout-automation**](../.agents/skills/pcb-layout-automation/SKILL.md) | EN | Skill | Procedural PCB layout, IPC-2152 automotive trace routing, thermal via arrays, and headless KiCad pcbnew DRC validation. |
| [**skills/esp32-firmware-engineering**](../.agents/skills/esp32-firmware-engineering/SKILL.md) | EN | Skill | Embedded firmware engineering for ESP32-S3 and ESP32-C6, 200 Hz PROFET PWM, sliding window anti-replay, LP-GPIO sleep wakeups, and native TDD. |
...
| [**skills/cross-domain-sync**](../.agents/skills/cross-domain-sync/SKILL.md) | EN | Skill | Cross-domain co-design audit matrix synchronizing Atopile netlists, KiCad layout, firmware GPIOs, and parametric CAD apertures. |
...
| Document | Language | Status | Summary |
| :--- | :---: | :---: | :--- |
| [**logic_audit_2026-09-11.md**](logic_audit_2026-09-11.md) | EN | Active (Must Read) | Current comprehensive logic audit: 11ch vs 24ch identity split, Shower Mode keep-alive oscillation, encoder dual-dispatch, missing DoubleClick, XIAO D10/GPIO9 LED error. |
| [**logic_audit_2026-09-03.md**](logic_audit_2026-09-03.md) | EN | Historical (Closed blockers) | Prior audit of 7 critical flaws (DevKit GND short, replay bypass, 5 kHz PWM, 3.3V Zener). Blockers fixed; superseded by 2026-09-11. |
