...
| [**breadboard_prototyping_and_validation_guide.md**](breadboard_prototyping_and_validation_guide.md) | EN | Active (Lab) | Bench bring-up for 24-ch firmware + entrance remote: USB Phase A, fused 12 V Phase B, current pin map. |
